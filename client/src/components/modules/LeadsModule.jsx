...
// ─── Sample Leads Data ────────────────────────────────────────────
const SAMPLE_LEADS = [
  { id: 'LD-2026-001', name: 'Rajesh Kumar', company: 'TechVista Solutions', contactPerson: 'Rajesh Kumar', email: 'rajesh@techvista.com', phone: '+91 98765 43210', whatsapp: '+91 98765 43210', website: 'techvista.com', country: 'India', state: 'Tamil Nadu', city: 'Chennai', industry: 'IT Services', status: 'New', source: 'Google Ads', assignedTo: 'Arun M', service: 'CRM', budget: '₹5,00,000', date: '2026-08-05', priority: 'High' },
  { id: 'LD-2026-002', name: 'Sarah Johnson', company: 'BlueWave Digital', contactPerson: 'Sarah Johnson', email: 'sarah@bluewave.io', phone: '+1 555 234 5678', whatsapp: '+1 555 234 5678', website: 'bluewave.io', country: 'USA', state: 'California', city: 'San Francisco', industry: 'E-Commerce', status: 'Contacted', source: 'LinkedIn', assignedTo: 'Priya S', service: 'Website', budget: '$12,000', date: '2026-08-04', priority: 'Medium' },
  { id: 'LD-2026-003', name: 'Mohammed Al-Rashid', company: 'Gulf Enterprises LLC', contactPerson: 'Mohammed Al-Rashid', email: 'mohammed@gulfent.ae', phone: '+971 50 123 4567', whatsapp: '+971 50 123 4567', website: 'gulfenterprises.ae', country: 'UAE', state: 'Dubai', city: 'Dubai', industry: 'Real Estate', status: 'Qualified', source: 'Referral', assignedTo: 'Karthik R', service: 'Mobile App', budget: 'AED 50,000', date: '2026-08-03', priority: 'High' },
  { id: 'LD-2026-004', name: 'Priya Menon', company: 'HealthFirst India', contactPerson: 'Priya Menon', email: 'priya@healthfirst.in', phone: '+91 87654 32109', whatsapp: '+91 87654 32109', website: 'healthfirst.in', country: 'India', state: 'Kerala', city: 'Kochi', industry: 'Healthcare', status: 'Proposal Sent', source: 'Website', assignedTo: 'Arun M', service: 'AI Agent', budget: '₹8,00,000', date: '2026-08-02', priority: 'High' },
  { id: 'LD-2026-005', name: 'David Chen', company: 'NovaTech Corp', contactPerson: 'David Chen', email: 'david@novatech.sg', phone: '+65 9123 4567', whatsapp: '+65 9123 4567', website: 'novatech.sg', country: 'Singapore', state: 'Singapore', city: 'Singapore', industry: 'FinTech', status: 'Negotiation', source: 'Partner', assignedTo: 'Priya S', service: 'Software Development', budget: 'SGD 25,000', date: '2026-08-01', priority: 'Critical' },
  { id: 'LD-2026-006', name: 'Anita Sharma', company: 'EduStar Academy', contactPerson: 'Anita Sharma', email: 'anita@edustar.co.in', phone: '+91 76543 21098', whatsapp: '+91 76543 21098', website: 'edustar.co.in', country: 'India', state: 'Maharashtra', city: 'Mumbai', industry: 'Education', status: 'Won', source: 'Facebook', assignedTo: 'Karthik R', service: 'Digital Marketing', budget: '₹2,50,000', date: '2026-07-30', priority: 'Low' },
  { id: 'LD-2026-007', name: 'James Wilson', company: 'BuildRight Construction', contactPerson: 'James Wilson', email: 'james@buildright.co.uk', phone: '+44 7700 900123', whatsapp: '+44 7700 900123', website: 'buildright.co.uk', country: 'UK', state: 'London', city: 'London', industry: 'Construction', status: 'Lost', source: 'Cold Call', assignedTo: 'Arun M', service: 'Website', budget: '£8,000', date: '2026-07-28', priority: 'Medium' },
  { id: 'LD-2026-008', name: 'Lakshmi Narayanan', company: 'AgriTech Solutions', contactPerson: 'Lakshmi N', email: 'lakshmi@agritech.in', phone: '+91 65432 10987', whatsapp: '+91 65432 10987', website: 'agritech.in', country: 'India', state: 'Karnataka', city: 'Bangalore', industry: 'Agriculture', status: 'Follow Up', source: 'Instagram', assignedTo: 'Priya S', service: 'SEO', budget: '₹1,50,000', date: '2026-07-25', priority: 'Medium' },
];
                  ...
                  >
                    ...
                    <td style={{ padding: '0.75rem 0.75rem' }}>
                      <div style={{ display: 'flex', gap: '0.4rem' }}>
                        <button title="Call" style={{ background: 'rgba(5, 150, 105, 0.1)', border: 'none', borderRadius: '6px', padding: '0.3rem', cursor: 'pointer', color: '#059669' }}>
                          <Phone size={13} />
                        </button>
                        <button title="Email" style={{ background: 'rgba(37, 99, 235, 0.1)', border: 'none', borderRadius: '6px', padding: '0.3rem', cursor: 'pointer', color: '#2563EB' }}>
                          <Mail size={13} />
                        </button>
                        <button title="WhatsApp" style={{ background: 'rgba(34, 197, 94, 0.1)', border: 'none', borderRadius: '6px', padding: '0.3rem', cursor: 'pointer', color: '#16A34A' }}>
          ...
          <div style={{
            ...
            <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              {detailTab === 'overview' && (
                <>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <button className="btn-secondary" style={{ fontSize: '0.78rem', padding: '0.4rem 0.75rem', color: '#059669' }}>
                      <Phone size={13} /> Call
                    </button>
                    <button className="btn-secondary" style={{ fontSize: '0.78rem', padding: '0.4rem 0.75rem', color: '#2563EB' }}>
                      <Mail size={13} /> Email
                    </button>
                    <button className="btn-secondary" style={{ fontSize: '0.78rem', padding: '0.4rem 0.75rem', color: '#16A34A' }}>
