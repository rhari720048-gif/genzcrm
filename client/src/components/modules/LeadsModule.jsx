...
export default function LeadsModule({ onConvertClient, onScheduleFollowUp }) {
  ...
  const handleAddLead = (e) => {
    ...
    const newLead = {
      ...formData,
      id: `genz-ld-${String(leads.length + 1).padStart(3, '0')}`,
